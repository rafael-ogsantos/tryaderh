<?php
     ...
     mysqli_query($link,"insert into depoimentos(comentarios)values('$mensagem')");
     echo '<!DOCTYPE html>
      <html>
      ...
      <body>
          ...
          <div id="fundo-preto">
              <div class=" container">
              <a href="depoimentos">Voltar</a> 
                  <div class="padding text-center">
                         <h1  style="color:white;margin-top:100px;">Obrigado por compartilhar sua opiniao com a gente!!!</h1>
